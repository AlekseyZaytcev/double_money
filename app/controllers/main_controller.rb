class MainController
  ...
  def initialize
    ...
    @hours = NominalHoursService.call(File.join(ROOT_PATH, 'hours.yml'))
  ...
  def run
    @window.set_title 'Double Money 3.0'
    @window.show
    Gtk.main
  end
  ...
  def app_calculate
    ...
    @result_label.text = SalaryService.call(salary, hours, shifts).round(2).to_s + ' грн.'
  end
end
